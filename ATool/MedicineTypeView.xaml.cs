...
namespace ATool
{
    ...
    public partial class MedicineTypeView : UserControl
    {
        ...
        private void Add(string strName, double price)
        {
        ...
        private void btnDelete_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            var medicineType = button.DataContext as MedicineType;
            if (medicineType != null && !string.IsNullOrEmpty(medicineType.StrName) && medicineType.Price != null)
            {
                CollectionData.Remove(medicineType);
            }
        }
    }
}
